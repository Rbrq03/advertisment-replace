...
__all__ = ["Adrecover_mapper"]



class Adrecover_mapper:
    """
    ...
    def get_sup_img_pairs(self, class_chosen, image_path):
        ...
        if self.shot == 5:
            for i in range(1, 6):
                support_image_path_list.append(os.path.join(root, "support_image", f"image{i}"))
                support_label_path_list.append(os.path.join(root, "support_mask", f"mask{i}"))
                
        elif self.shot == 1:
            support_image_path_list.append(os.path.join(root, "support_image", "image1"))
            support_label_path_list.append(os.path.join(root, "support_mask", "mask1"))
